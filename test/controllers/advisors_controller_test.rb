...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post advisors_url, params: { advisor: { description: @advisor.description, duration: @advisor.duration, name: @advisor.name } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { description: @advisor.description, duration: @advisor.duration, name: @advisor.name } }
